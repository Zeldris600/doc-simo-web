...
export default function AdminProductsPage() {
 ...
 return (
 <span
 className={`font-medium ${displayStock === 0 ? "text-destructive" : "text-black/50"}`}
 >
 ...
 >
 <DropdownMenuLabel className="text-xs font-medium uppercase text-black/30">
 Manage
 </DropdownMenuLabel>
 <DropdownMenuItem
 ...
 >
 <DialogContent className="sm:max-w-md rounded-xl border-black/10 shadow-none">
 <DialogHeader>
 <DialogTitle className="text-lg font-medium">Restock Product</DialogTitle>
 ...
 <div className="py-4">
 <label className="text-xs font-medium uppercase text-black/40 mb-2 block">
 Quantity to add
 </label>
 <Input
 type="number"
