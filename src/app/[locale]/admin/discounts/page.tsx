  ...
  const columns: ColumnDef<Discount>[] = [
    {
      ...
      header: "Code",
      cell: ({ row }) => (
        <span className="font-black text-black uppercase tracking-wider text-xs bg-black/[0.03] px-3 py-1.5 rounded-lg">
          {row.getValue("code")}
        </span>
      ),
    },
    {
      ...
      cell: ({ row }) => (
        <Badge
          variant="outline"
          className={`rounded-lg px-3 py-0.5 text-[10px] font-black uppercase tracking-widest border-none ${
