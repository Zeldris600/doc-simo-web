...
export default function AdminUsersPage() {
 ...
 <AvatarFallback className="bg-primary/5 text-primary font-medium rounded-lg">
 {(user.name || "U").charAt(0).toUpperCase()}
 </AvatarFallback>
 </Avatar>
 <div className="flex flex-col">
 <span className="font-medium text-black uppercase text-[11px] ">
 ...
 disabled={isUpdating}
 >
 <SelectTrigger className="w-[140px] h-9 bg-white border-gray-100 rounded-lg text-[10px] font-medium uppercase ">
 ...
 <Badge
 variant="outline"
 className="bg-green-50 text-green-700 border-none font-medium text-[8px] uppercase px-3 py-1 rounded-full"
 >
 Active
 </Badge>
 ),
 ...
 <div className="bg-white border-none rounded-xl p-2">
 <div className="flex items-center gap-4 mb-6 p-4 bg-gray-50/50 rounded-xl border border-gray-100">
 <span className="text-[10px] font-medium uppercase [0.2em] text-black/30 mr-2">
 Filter by Role:
 </span>
 <Select value={params.role || "ALL"} onValueChange={handleRoleFilter}>
 <SelectTrigger className="w-[180px] h-9 bg-white border-gray-200 rounded-lg text-[10px] font-medium uppercase ">
 ...
 {isUpdating && (
 <div className="fixed bottom-8 right-8 bg-black text-white px-6 py-4 rounded-xl flex items-center gap-4 shadow-2xl animate-in slide-in-from-bottom-10">
 <Loader2 className="h-5 w-5 animate-spin" />
 <span className="text-xs font-medium uppercase ">
 Updating Registry Node...
 </span>
 </div>
 )}
 </div>
