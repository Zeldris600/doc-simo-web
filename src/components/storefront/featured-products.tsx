      ...
      <div className="container max-w-7xl mx-auto">
        ...
        <div className="flex items-end justify-between mb-10 gap-4">
          <div className="space-y-2">
            ...
            <h2 className="text-xl sm:text-2xl font-semibold text-primary tracking-tight leading-tight">
              Signature Remedies
            </h2>
          ...
          <Link
            href="/products"
            className="hidden sm:inline-flex items-center gap-2 text-xs font-semibold text-primary hover:opacity-70 transition-all group uppercase tracking-widest shrink-0"
          >
            Browse all
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
            ...
            {hero && (
              ...
              >
                ...
                {/* Badge */}
                {hero.isHot && (
                  <div className="absolute top-5 left-5 flex items-center gap-1.5 bg-[#f2c94c] text-[#142c1b] px-3 py-1.5 rounded-full text-[10px] font-semibold uppercase tracking-wider">
                ...
                <div className="absolute inset-x-0 bottom-0 p-7 space-y-3">
                  ...
                  <div className="flex items-center justify-between pt-2">
                    ...
                    <div className="flex items-center gap-2 bg-white text-primary px-5 py-2.5 rounded-full text-xs font-semibold group-hover:bg-[#f2c94c] group-hover:text-[#142c1b] transition-colors">
            ...
            <div className="lg:col-span-2 flex flex-col gap-4">
                ...
                >
                  ...
                  <div className="flex flex-col justify-between flex-1 min-w-0 py-0.5">
                    <div className="space-y-1">
                      ...
                      <h4 className="text-sm font-semibold text-primary leading-tight line-clamp-2 group-hover:underline underline-offset-2">
                        {p.name}
                      </h4>
                    ...
                    <div className="flex items-center justify-between mt-2">
                      ...
                      <span className="inline-flex items-center gap-1 text-[10px] font-semibold text-primary bg-primary/10 px-3 py-1.5 rounded-full group-hover:bg-primary group-hover:text-white transition-colors">
              ...
              <Link
                href="/products"
                className="sm:hidden flex items-center justify-center gap-2 text-xs font-semibold text-primary border-2 border-primary/20 rounded-2xl py-4 hover:bg-primary/5 transition-colors"
              >
                Browse all products
