    ...
    <section className="px-6 py-24 lg:px-12 bg-transparent relative overflow-hidden">
      ...
      <div className="container max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-16 space-y-4">
          <span className="text-xs font-semibold text-primary bg-primary/10 px-4 py-1.5 rounded-full border border-primary/20 tracking-[0.1em] uppercase">
            {t("label")}
          </span>
          <h2 className="text-xl md:text-2xl font-semibold text-[#173b27] tracking-tighter leading-none">
            {t("title")}
          </h2>
              ...
              >
                ...
                <div className="absolute inset-x-0 bottom-0 p-8 pt-20 flex flex-col gap-3 z-10">
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-[10px] text-white/80 font-semibold tracking-[0.2em] uppercase">
                      {t("node")}
                    </span>
                  </div>
                  <h3 className="text-base font-semibold text-white tracking-tight leading-tight group-hover:scale-105 transition-transform origin-left">
                    {category.name}
                  </h3>
                  ...
                  <div className="flex items-center gap-2 text-white text-[10px] font-semibold tracking-widest mt-4 opacity-0 group-hover:opacity-100 -translate-x-4 group-hover:translate-x-0 transition-all duration-500 uppercase">
                    {t("access")}
