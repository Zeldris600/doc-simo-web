...
export function StorefrontFooter() {
 ...
 <p className="text-[10px] font-medium text-[#f2c94c]">
 Stay in the loop
 </p>
 ...
 <button
 type="submit"
 className="h-11 px-5 rounded-xl bg-[#f2c94c] text-[#142c1b] text-xs font-medium hover:bg-[#f0c040] transition-colors flex items-center gap-1.5 shrink-0"
 >
 ...
 <Link
 href="/consultation"
 className="inline-flex items-center gap-2 bg-[#f2c94c] text-[#142c1b] px-5 py-2.5 rounded-full text-xs font-medium hover:bg-[#f0c040] transition-colors"
 >
 ...
 <h4 className="text-[10px] font-medium text-[#f2c94c]">
 Shop
 </h4>
 ...
 <div className="flex flex-wrap items-center justify-center md:justify-start gap-4 text-[10px] text-white/30 font-medium ">
 <span>
