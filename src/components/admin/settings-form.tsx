  ...
  return (
    <Form {...form}>
      <form
        ...
        className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-1500"
      >
            ...
            <Card className="border-black/5 rounded-lg overflow-hidden bg-white/50 backdrop-blur-md">
              <CardHeader className="bg-black text-white p-10">
                ...
                <CardDescription className="text-white/40 font-bold uppercase text-[10px] tracking-[0.2em] mt-1">
                  Global metadata and application identity.
                </CardDescription>
              </CardHeader>
              <CardContent className="p-10 space-y-8">
                <div className="grid md:grid-cols-2 gap-8">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-black/60 font-black uppercase tracking-[0.2em] text-[10px]">
                          Registry Name
                        </FormLabel>
                        <FormControl>
                          <Input
                            {...field}
                            className="bg-black/[0.02] border-black/10 focus:border-black rounded-lg h-14 font-black text-xl "
                          />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            {...field}
                            className="bg-black/[0.02] border-black/10 focus:border-black rounded-lg h-14 font-bold text-sm uppercase tracking-tight"
                          />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border border-black/5 bg-rose-500/[0.02] p-8 transition-all hover:bg-rose-500/5 hover:-rotate-1">
                      <div className="space-y-1">
                        <FormLabel className="text-rose-600 font-black uppercase tracking-[0.2em] text-xs">
                          System Lock (Maintenance)
                        </FormLabel>
                      ...
                      <FormControl>
                        <Checkbox
                          ...
                          className="h-5 w-5 data-[state=checked]:bg-rose-600"
                        />
                      </FormControl>
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="flex flex-row items-center justify-between rounded-lg border border-black/5 bg-emerald-500/[0.02] p-8 transition-all hover:bg-emerald-500/5 hover:rotate-1">
                      <div className="space-y-1">
                        <FormLabel className="text-emerald-600 font-black uppercase tracking-[0.2em] text-xs">
                          Broadcast Protocol
                        </FormLabel>
            ...
            <div className="space-y-4">
              {[
                ...
                <Button
                  key={i}
                  variant="outline"
                  className="w-full h-16 rounded-lg border-black/5 justify-between px-6 hover:bg-black hover:text-white transition-all group active:scale-[0.98]"
                >
