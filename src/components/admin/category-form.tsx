...
export function CategoryForm({ initialData, onSuccess }: CategoryFormProps) {
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-black/60 font-bold uppercase tracking-widest text-[10px]">Title</FormLabel>
 <FormControl>
 <Input 
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-black/60 font-bold uppercase tracking-widest text-[10px]">Slug identifier</FormLabel>
 <FormControl>
 <Input 
 ...
 <FormDescription className="text-[10px] uppercase font-bold text-black/20">Unique URL address key.</FormDescription>
 <FormMessage />
 </FormItem>
 )}
 />
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-black/60 font-bold uppercase tracking-widest text-[10px]">Catalog image</FormLabel>
 <FormControl>
 <ImageUploader 
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-black/60 font-bold uppercase tracking-widest text-[10px]">Medical details</FormLabel>
 <FormControl>
 <Textarea 
