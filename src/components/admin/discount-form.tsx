...
export function DiscountForm({ initialData, onSuccess }: DiscountFormProps) {
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-black/60 font-bold uppercase tracking-widest text-[10px]">Voucher Code</FormLabel>
 <FormControl>
 <Input 
 ...
 <FormDescription className="text-[10px] uppercase font-bold text-black/20 ">Case-insensitive alphanumeric key.</FormDescription>
 <FormMessage />
 </FormItem>
 )}
 />
 ...
 <FormLabel className="text-black/60 font-bold uppercase tracking-widest text-[10px]">Active Status</FormLabel>
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-black/60 font-bold uppercase tracking-widest text-[10px]">Reduction Type</FormLabel>
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-black/60 font-bold uppercase tracking-widest text-[10px]">Incentive Value</FormLabel>
 <FormControl>
 <Input 
 type="number"
 placeholder="0.00" 
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-black/60 font-bold uppercase tracking-widest text-[10px]">Termination Date</FormLabel>
 <FormControl>
 <Input 
 type="date"
 {...field} 
